...
<head>
    ...
    <title>Online Class Tutes | Online Learning Platforms | Student Panel</title>
    <?php
    ...
    <div class="wrapper">
        <div class="sa4d25">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="item_title">Online Class Tutes</h4>
                        ...
                        <div class="_14d25">
                            <div class="row">
                                ...
                                if (isset($_POST['fil_bt'])) {
                                    ...
                                    $tute_qury = mysqli_query($conn, "SELECT * FROM lmsclasstute WHERE class='$user_resalt[level]' and subject IN ($sub_array_join) and ctype='Online Class' and status='1'");
